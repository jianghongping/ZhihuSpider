...
def answer_msg(content):
    ...
    answer_dict = {'author': user_msg_dict['name'],
                   'author_avatar_url': user_msg_dict['author_avatar_url'],
...
def article_msg(content):
    ...
    article_dict = {'author': user_msg_dict['name'],
                    'author_avatar_url': user_msg_dict['author_avatar_url'],
                    'author_page': user_msg_dict['author_page'], 'title': title,
                    'original_url': original_url, 'created_date': date,
...
def init_user_msg(user_id):
    ...
    if response is None:
        ...
        user_msg_dict['author_avatar_url'] = response_json['avatar_url_template'].replace(
            const.AVATAR_SIZE_R,
            const.AVATAR_SIZE_A)
